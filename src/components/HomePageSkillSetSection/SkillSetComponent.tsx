      ...
      <div className="skillset-container">
        <div className="skillset-section">
          ...
          <div className="grid-container">
            <CardContainer
              iconSrc="src\assets\icons\IconSvg_DataBase.svg"
            ...
            />
            <CardContainer
              iconSrc="src\assets\icons\iconSvg_PhoneCameraZoom.svg"
            ...
            />
            <CardContainer
              iconSrc="src\assets\icons\WebDevelopment.svg"
